...
```{r resultsTab, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
mytable = data.frame(
    CoverClass = c("Grassland", "Canola", "Pasture", "Woodland", "Pulses", "Road margins"),
    PteMel = c('* Local sink (late)','* Local source (early) \n* Landscape sink (early)',' ',' ','* Source (late)',' '),
...
names(mytable) <- c('Cover class','_Pterosticus\nmelanarius_','_Pardosa distincta_','_Pardosa moesta_','Phalangium opilio')
