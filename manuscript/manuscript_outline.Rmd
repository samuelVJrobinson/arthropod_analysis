...
## Data collection
We used a set of 169 pitfall traps installed at roadsides, field margins, wetlands, and in-field sites across southern Alberta, Canada in 2017 (_need a map here_).
Pitfall traps consisted of 582 mL Solo® cups buried up to the rim, partially filled with ethylene glycol.
All traps had 2 cm wire mesh mounted over the rim to prevent vertebrates from falling into the traps.
Traps at roadsides were located 5m from the roads, while traps at in-field sites were installed at 0, 25, 75, and 200 m along a transect heading away from the nearest non-crop feature (wetland, grassland, grassy field corners).
Specimens were collected from the traps on average every 14 days (SD: 2.9), and were identified to species.
  
We used four highly-abundant species of predatory arthropods found in the pitfall traps, as common species drive ecosystem service provision more than rare species [@winfree2015].
