...
date: "Spring 2020"
abstract: Ground-dwelling arthropods are important generalist predators in prairie agro-ecosystems. 
However, we don't know what types of landscape features are useful for which types of arthropods, and during which parts of the year.
Habitat features may act as sources of arthropods during some times of the year, but act as sinks at other times.
We modeled the activity density of four widely-distributed species of arthropods, and used functional regression to reveal their habitat preferences. 
We found that trees/shrubs, and roadside grasses acted as sources of arthropods. 
Other features did not function as significant sources or sinks. 
Farmers should consider retaining these landscape features in order to preserve populations of helpful generalist predators in their crops.
...
Landscape structure drives beneficial arthropod abundance [@albrecht2010], and is key for understanding how to manage benefical arthropods in agroecosystems
...
Ground-nesting bees are generally driven by flower/nest substrate availability [@roulston2011], and beetles can be limited by water, food, and oviposition sites [@lovei1996].
However, while the effect of SNL on bees is generally positive, its effect on beetles and parasitoids is unclear [@shackelford2013] 
Other organisms may use SNL as travel corridors or overwintering sites, but may not be directly dependent on them.
Spillover from SNL occurs when organisms migrate from SNL into adjacent cropland [@woodcock2016; @scheiner2020]. 
...
Abundance of benefical arthropods is also influenced by spatio-temporal processes, such as phenology and migration.
...
Finally, different SNL patches may act as sources or sinks of arthropods at different times of the year, but this is rarely considered [@desender1988]
...
2) Crops in agricultural land attract pest insects during the growing season, and these insects are preyed upon by beneficial arthropods, meaning that crops consitute  
...
<!-- This table looks like garbage, but I don't think pander will make it any better -->
...
_Phalangium opilio_ activity density responded grasslands and wetlands (p=`r with(opilSmTerms,p[Smoother=='ti(distMat,endDayMat):GrassWetland'])`) and trees/shrubland (p=`r with(opilSmTerms,p[Smoother=='ti(distMat,endDayMat):TreeShrub'])`).
