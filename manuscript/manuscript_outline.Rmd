...
Table: (\#tab:sumTab) Summary table of results. Early, mid, and late indicate the time of the season when cover classes had strong effects on abundance. Italics indicates that effects were weak (95% intervals overlapped zero)
...
+-----------------+----------------------------+----------------------------+-----------------------------+-----------------------+
| Trees/Shrubland |                            | - Overall sink (late)      | - _Overall source (early)_  | - Local sink (early)  |
...
* The predatory ground beetle _Pterostichus melanarius_ responded to landscape composition, primarily to different crop types (Table \@ref(tab:sumTab),\@ref(tab:PteMelSmooth))
 ...
 + We found that canola and pulse crops acted as early- and mid-season sources of _P. melanarius_ 
 ...
 + Alternatively, _P. melanarius_ is known to predate upon other carabid predators of _S. lineatus_, such as _Bembidion quadrimaculatum_ [@vankosky2011]
 ...
 + Surprisingly, flax acted as a local and landscape level sink, suggesting that it may be inappropriate feeding or nesting cover for _P. melanarius_.
 + To our knowledge, there is no published research demonstrating this
