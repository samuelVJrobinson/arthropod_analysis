...
```{r landscapeComp, echo=FALSE, fig.cap='Landscape composition in annuli surrounding each trap location'}  
  include_graphics('../figures/oRingPlot2_AAFC.png')
```
