...
Agriculture constitutes ~36% of land worldwide [@ramankutty2018], meaning large conservation potential
Potential for win-win scenarios
  
Landscape structure drives beneficial arthropod abundance [@albrecht2010], and is key for understanding how to manage benefical arthropods in agroecosystems [@martin2020]
...
Ground-nesting bees are generally driven by flower/nest substrate availability [@roulston2011], and beetles can be limited by water, food, and oviposition sites [@lovei1996; @gardiner2010].
...
1. Untilled semi-natural land (SNL) provides oviposition and feeding areas for predatory arthropods, meaning that nearby SNL should act as a source of arthropods during the early part of the season, and a sink during the later part of the season. 
2. Crops in agricultural land act as sources of pest insects during the growing season, while crop senescence at the end of the season causes a crash in the number of pests. This should result in agricultural land becoming a sink for predators in the early part of the season as they migrate into the crop, and a source at the end of the season as they migrate out of the crop.
