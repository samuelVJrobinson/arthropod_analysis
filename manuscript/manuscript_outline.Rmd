...
r2Nakagawa2 %>% select(model,terms,r2comp) %>% mutate(terms=as.character(terms),r2comp=r2comp*1) %>%
  ...
  kable(.,format='latex',caption='R$^2_{GLMM}$ for model components, representing the proportion of total variance attributable to each term.',
...
# 
# kable(test_data,"latex" ,booktabs=T, align="c",
