...
* The wolf spiders _Pardosa distincta_ and _Pardosa moesta_ both responded to landscape composition, but in slightly different ways
  ...
  + Trees and shrubs acted as a late season sink in both species, suggesting that they migrate to off-field areas with woody shrubs and trees 
  + @drapela2011 also found that _Pardosa agrestis_ had higher activity density in areas with woody trees and shrubs
  + While _Pardosa_ are found in areas close to disturbed roadside strips [@drapela2011; @kowal2011], _P. distincta_ appears to be less sensitive to disturbances than _P. moesta_ [@collins1996; @wade2010]
  ...
  a wandering-active predation strategy [@young1990], 
