...
* We found that while _Pterostichus melanarius_, _Pardosa distincta_, and _Pardosa moesta_ responded to landscape composition, _Phalangium opilio_ did not
  ...
  + These results highlight the important of non-crop marginal lands for predatory arthropod abundance 
  
Cover class     | _Pterostichus_          | _Pardosa_               | _Phalangium_
--------------- | ----------------------- | ----------------------- | ------------
Grass/Wetland   | Late sink               | Early source (weak)     |
Canola          |                         | Early, mid source       |
Pasture         | Early source            |                         | Early sink, late source
Trees/Shrubland | Early sink, Late source | Variable                | Early sink, mid source (weak)
Pulses          | Source                  | Variable                |
Flax            |                         |                         |
Urban           | Early sink, Mid source  | Variable                |


* The predatory ground beetle _Pterostichus melanarius_ responded to landscape composition, and responded most strongly to urban and tree/shrub land cover
...
* There was a strong temporal component to the landscape effects, meaning that it is important to consider how sinks and sources may change over the year
...
* These patterns indicate movement between landscape features, but since we did not directly observe arthropod movement between features, future studies should examine this
  + Mark-recapture studies or two-sided traps would be a good start
  + Should also be linked to ecosystem services (e.g. predation on bait insects - imagine the scene from Jurassic Park where the T-rex eats the goat)
