...
Positive effects of nearby landscape cover classes indicate that the cover class acts as a net source (i.e. arthropods spill over *from* it).
...
For brevity in the following Results section, we refer to "local" and "landscape"-level effects; local refers to the effects of landscape composition at scales of <500m, whereas landscape refers to scales >500 m.
...
Pasture had a negative effect at the landscape scale, and woodland had a late-season negative effect, suggesting that _P. distincta_ move to shrubs and trees for overwintering or winter foraging [@aitchison1984; @buddle2000].
