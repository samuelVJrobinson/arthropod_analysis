...
This resulted in a reduced set of landscape terms, none of which were strongly concurved with each other (cropland: canola, pulses; SNL: grassland, pasture, woodland, urban; see Figure \@ref(fig:concurvity)).
...
We found support for our predictions of SNL (grassland, woodlands, and road margins) acting as a late-season sinks for beneficial arthropods.
In particular, _P. melanarius_ was attracted to grasslands, _P. distincta_ to woodlands, and _P. moesta_ to road margins, all at the end of the season.
While there was limited evidence of SNL acting as early-season sources, some cover classes had a positive effect at the landscape level (grassland and road margins on _P. moesta_), indicating earlier or wider-scale dispersal away from these cover classes.
Canola and pasture had negative landscape-level effects on _P. melanarius_ and _P. distincta_, respectively, meaning that these cover types likely represent only partial habitat for these arthropods.
...
Grassland and wetland cover had a negative late-season effect, suggesting that _P. melanarius_ may migrate into it at the end of the summer.
...
Our models also suggest this, as they showed that canola and pulse crops had positive effects on _P. melanarius_ activity-density early in the season.
...
Pasture had a negative effect at the landscape scale, and woodland acted as a late season sink, suggesting that _P. distincta_ use shrubs and trees for overwintering or winter foraging [@aitchison1984; @buddle2000].
...
_Phalangium opilio_ activity-density responded to grass and wetland cover, as well as trees and shrubs.
...
These patterns imply movement of organisms between landscape features, but since we did not directly measure this, future studies should directly examine arthropod movement and life-history within matrices of cover types, with the goal of integrating landscape ecology and behavioural processes into a single model [@lima1996].
