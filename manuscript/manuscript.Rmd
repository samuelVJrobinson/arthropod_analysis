...
address:
  ...
  - code: Oregon State University
    address: 1500 SW Jefferson Way, Corvallis, OR
footnote:
  - code: 1
    text: "Corresponding Author"
date: "Spring 2020"
abstract: "Ground-dwelling arthropods can be important generalist predators in agro-ecosystems, and can use non-crop features as overwintering habitats. However, it is unclear which types of landscape features constitute useful non-crop habitat, and at what spatial scale organisms gather resources. Additionally, the same landscape feature may act as an origin or destination for arthropods at different times of the year, but this is rarely considered. We modeled the activity-density of four highly-abundant species of Canadian prairie arthropods, and used functional regression to simultaneously consider both their habitat preferences and the timing of origins and destinations. _Pterostichus melanarius_ (Coleoptera: Carabidae) and _Pardosa moesta_ (Arachnida: Lycosidae) appear to be attracted to canola (_Brassica napus_ L.) during the early summer, then dispersed to grasslands, wetlands, and grassy road margins during the end of the summer. This suggests that grasslands and wetlands act as reservoir habitats for predatory arthropods, and that farmers should consider preserving existing habitat in order to maintain pest-control services across the season."
...
# Introduction
<!-- DE: BIOCONTROL THEME NEEDS SET-UP IN INTRODUCTION -->
...
First, non-crop habitat may act as an origin of arthropods during some times of the year, but as a destination during other times, meaning that the timing of spillover from non-crop habitat may not align with important periods of crop growth.
Arthropods can move from crops back into SNL at the end of the season [@desender1988; @tscharntke2005b], but this is seldom considered.
...
1. Untilled semi-natural land provides egg-laying and feeding areas for predatory arthropods, meaning that it should act as an _origin_ of arthropods during the early part of the season, and a _destination_ during the later part of the season. 
2. Crops provide food (pest insects) for predatory arthropods during the growing season. This should result in agricultural land becoming a destination for predators in the early part of the season as they migrate into the crop, and an origin at the end of the season as they migrate out of the crop.
...
This makes it impossible to disentangle arthropod activity from density using single traps [@lang2000; @zhao2013], meaning that counts from traps represent the "activity-density" of a given organism, not absolute density.
...
```{r siteMap, echo=FALSE, fig.cap='Classified land cover and location of pitfall traps during 2017. Inset map shows study location within Alberta provincial boundaries. Roadside traps were installed in road margins, while in-field traps were installed directly in canola fields, wetlands, or grassy field edges.', out.width='100%'}  
...
It also allows for the possibility that certain land cover types may be locally beneficial, but detremental at large scales, indicating that the cover type may not constitute a completely usable habitat.
...
Functional regression plots of landscape composition reveal which cover classes are acting as origins or destinations of a given arthropod, and at what spatial scale.
Positive effects of nearby landscape cover classes indicate that arthropods are spilling over *from* it, therefore acting as an origin.
...
For example, a cover class with low-quality habitat could act as an ecological trap [@galpern2017] if it acts as a destination but never as an origin.
Alternatively, a cover class could act as a destination by providing high-quality habitat at certain times of the year (e.g. egg laying/feeding), but act as an origin at other times (e.g. during emergence).
...
Pulses acted as a late-season origin, indicating that _P. melanarius_ may migrate out of the crop after (or during) harvest (Figure \@ref(fig:PteMelLandscape)d).
...
Local road margins also had a similar effect, acting as an early origin and a late destination (Figure \@ref(fig:ParMoeLandscape)d).
...
<!-- JV: THIS EAST-WEST PATTERN SHOULD BE MENTIONED IN THE DISCUSSION -->
...
There was little evidence of SNL acting as early-season origins, aside from road margins having a positive early effect on _P. moesta_ activity-density.
...
There was also a strong temporal component to most of the landscape effects, meaning that it is important to consider how destinations and origins may change over the season.

<!-- 1. ... nearby SNL should act as an origin of arthropods during the early part of the season, and a destination during the later part of the season.  -->
<!-- 2. ... should result in agricultural land becoming a destination for predators in the early part of the season as they migrate into the crop, and an origin at the end of the season as they migrate out of the crop. -->
...
However, there was also a strong East-West spatial random effect in both _P. opilio_ and _P. moesta_, meaning that larger-scale geographic patterns (possibly related to rainfall or temperature) also influence their activity-density.
